...
// Maximo devuelve la posición del mayor elemento del arreglo, o -1 si el el arreglo es de largo 0. Si el máximo elemento aparece más de una vez, se debe devolver la primera posición en que ocurre.
